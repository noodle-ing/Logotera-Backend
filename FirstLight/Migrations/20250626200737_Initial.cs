...
namespace FirstLight.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanCreateTest = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "text", nullable: false),
                    LecturerTeacherId = table.Column<int>(type: "integer", nullable: true),
                    PracticeTeacherId = table.Column<int>(type: "integer", nullable: true),
                    SyllabusFilePath = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HomeTaskFiles_Modules_ModuleId",
                        column: x => x.ModuleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LectureFiles_Modules_ModuleId",
                        column: x => x.ModuleId,
                        principalTable: "Modules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PracticeFiles_Modules_ModuleId",
                        column: x => x.ModuleId,
                        principalTable: "Modules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeminarFiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SeminarFiles_Modules_ModuleId",
                        column: x => x.ModuleId,
                        principalTable: "Modules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HomeTaskFiles_ModuleId",
                table: "HomeTaskFiles",
                column: "ModuleId");

            migrationBuilder.CreateIndex(
                name: "IX_LectureFiles_ModuleId",
                table: "LectureFiles",
                column: "ModuleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PracticeFiles_ModuleId",
                table: "PracticeFiles",
                column: "ModuleId");

            migrationBuilder.CreateIndex(
                name: "IX_SeminarFiles_ModuleId",
                table: "SeminarFiles",
                column: "ModuleId");
